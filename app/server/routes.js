...
module.exports = function(app) {
	...
	res.render('main', {
	    ...
	    logoRedirect: 'http://suave.sdsc.edu'
	});
    });
    // JUPYTER
	...
	*/
	...
	SM.replaceSurvey(req, req.body.user[0], function(e, o){
		...
		if (o.dzc == null) {
		    ...
		    */
		    //JUPYTER					
		    SM.changeCollection(req, req.body.user[0], {"name": "default"},
					//JUPYTER					
					function(e){
					    if(e){
						res.status(400).send(e);
	...
	SM.cloneSurvey(req.body.old_name, req.body.new_name, req.body.author, req.cookies.user, function(e, o) {
	    if (e) {
		...
		req.body.name = req.body.new_name.replace(/[^\w]/gi, '_');
                if (o.dzc == null) {
                    ...
                    SM.changeImageDefinition(req, req.cookies.user, o.dzc,
					     function(e){
						 if(e){
						     res.status(400).send(e);
						 }else{
