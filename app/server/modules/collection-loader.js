...
exports.getSurveyColumnAndCollect = function(name, user, callback){
	...
	if (err) {
		...
		if(err){
		    ...
		    var result = output[0];
		    //spl:060318 -- This borks the selection ID.
...
exports.copyImages = function(imgPath, images, callback){
	...
	//spl:060318 -- Made copySync vs copy cuz the files didn't get
	// copied in time for spritesheet to snarf them in.
	fsx.copySync(files, tempPath// , function(error){
		     //     if(error){
		     // 	err = error;
		     //     }
		     // }
