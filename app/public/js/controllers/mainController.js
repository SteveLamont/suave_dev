function MainController()
{
	...
	if(PARA.datetime_filters.length == 0) PARA.datetime_filters = "None";
	...
	if (!$('#comment-on-item').hasClass('btn-raised')) {
	    ...
	    var string = chart.getImageURI()
	    //width='100%' height='100%' 		    
	    var img = "<img src='" + string + "'></img>";
	    var x = window.open();
	    x.document.open();
	...
	if(PARA.num_filters != "None" ||
	   PARA.datetime_filters != "None" ||
	   PARA.string_filters != "None"){
